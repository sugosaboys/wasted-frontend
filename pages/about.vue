...
<template>
   ...
   <navbar/>
   <div class="pt-25">
      <h1 data-aos="fade-zoom-in" data-aos-duration="1000" class=" text-left md:text-center text-[32px] md:text-[48px] ExposureTrialVARBold font-bold px-8 md:px-0 pt-5">{{ Contents.Title }}</h1>

      <section data-aos="fade-up" data-aos-duration="1000" class="flex justify-center items-center pt-[45px] px-8 md:px-15 lg:px-0">
      ...
      <main data-aos="fade-up" data-aos-duration="1000" class="pt-[45px]">
      ...
      <section class="pt-[130px]">
            <main data-aos="fade-up" data-aos-duration="1000" class="flex flex-col md:flex-row justify-center align-center gap-18">
               <div class="flex flex-col items-center">
                  <img :src=" Contents.ImageWithCaption.image.url" alt="Images" loading="lazy" class="w-[312px] h-[312px] md:w-[400px] md:h-[400px] lg:w-[640px] lg:h-[640px] object-cover">
                  <p class="GeistMono w-[312px] md:400px lg:w-[640px] text-center text-[14px] font-bold">{{ Contents.ImageWithCaption.caption }}</p>
               </div>
               <div class="flex flex-col items-center">
                  <img :src=" Contents.ImageWithCaption.ImageSecond.url" alt="Images" loading="lazy" class=" w-[312px] md:w-[300px] lg:w-[320px] h-[480px] object-cover">
            ...
            <main data-aos="fade-up" data-aos-duration="1000" class="flex flex-col md:flex-row justify-center align-center gap-18 mt-20">
               <div class="flex flex-col items-center">
                  <img v-if="Contents.ImageWithCaption?.ImageThird?.url" :src=" Contents.ImageWithCaption.ImageThird.url" alt="Images" loading="lazy" class="w-[540px] h-[810px] object-cover">
                  <p class="GeistMono w-[580px] text-center text-[14px] font-bold">{{ Contents.ImageWithCaption.captionThird }}</p>
               </div>
               <div class="flex flex-col items-center">
                  <img v-if="Contents.ImageWithCaption?.ImageFourth?.url" :src=" Contents.ImageWithCaption.ImageFourth.url" alt="Images" loading="lazy" class="w-[480px] h-[480px] object-cover">
                  <p class="GeistMono w-[320px] text-center text-[14px] font-bold">{{ Contents.ImageWithCaption.captionFourth }}</p>
               </div>
            </main>
            <main data-aos="fade-up" data-aos-duration="1000" class="flex justify-center align-center mt-0 md:mt-20">
      ...
      <section class="pt-[130px]">
            <main data-aos="fade-up" data-aos-duration="1000" class="flex flex-col md:flex-row justify-center align-center gap-18">
               <div class="flex flex-col items-center">
                  <img :src=" Contents.ImageCaption.image.url" alt="Images" loading="lazy" class="w-[312px] h-[208px] md:w-[438px] md:h-[380px] lg:w-[720px] lg:h-[480px] object-cover">
                  <p class="GeistMono w-[320px] md:w-[438px] lg:w-[730px] text-center text-[14px] font-bold">{{ Contents.ImageCaption.caption }}</p>
               </div>
               <div class="flex flex-col items-center">
                  <img :src=" Contents.ImageCaption.ImageSecond.url" alt="Images" loading="lazy" class="w-[320px] h-[320px] object-cover">
                  <p class="GeistMono w-[320px] text-center text-[14px] font-bold">{{ Contents.ImageCaption.captionSecond }}</p>
               </div>
            </main>
            <main data-aos="fade-up" data-aos-duration="1000" class="flex flex-col md:flex-row justify-center align-center gap-18 mt-20">
               <div class="flex flex-col items-center">
                  <img :src=" Contents.ImageCaption.ImageThird.url" alt="Images" loading="lazy" class="w-[312px] h-[468px] md:w-[400px] md:h-[610px] lg:w-[540px] lg:h-[810px] object-cover">
                  <p class="GeistMono w-[320px] md:w-[400px] lg:w-[580px] text-center text-[14px] font-bold">{{ Contents.ImageCaption.captionThird }}</p>
               </div>
               <div class="flex flex-col items-center">
                  <img :src=" Contents.ImageCaption.ImageFourth.url" alt="Images" loading="lazy" class="w-[312px] md:w-[380px] lg:w-[480px] h-[480px] object-cover">
                  <p class="GeistMono w-[312px] md:w-[400px] lg:w-[500px] text-center text-[14px] font-bold">{{ Contents.ImageCaption.captionSecond }}</p>
               </div>
            </main>
             <main data-aos="fade-up" data-aos-duration="1000" class="flex justify-center align-center mt-20">
      ...
      <FollowtheWastePageCTAbutton data-aos="fade-up" data-aos-duration="1000" class="flex justify-center align-center mt-[55px] mb-[55px] font-bold">
